...
export type DisableServiceInput = {
  /** Add your inputs here */
  serviceName: VetraCloudEnvironmentService | `${VetraCloudEnvironmentService}`;
};
...
export type VetraCloudEnvironmentState = {
  ...
  services: Array<
    VetraCloudEnvironmentService | `${VetraCloudEnvironmentService}`
  >;
  status: VetraCloudEnvironmentStatus | `${VetraCloudEnvironmentStatus}`;
};
