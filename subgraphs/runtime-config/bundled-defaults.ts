...
//
// Only the `connect.*` subtree is stored here — the surrounding envelope
// (schemaVersion / packages / localPackage / packageRegistryUrl) is emitter-
// stamped by the build pipeline and is not editable through this subgraph.
//
